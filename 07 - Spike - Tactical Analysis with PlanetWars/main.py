...
if __name__ == '__main__':
    ...
    map = randrange(0,100)
    gamestate = open('./maps/map%s.txt' % map).read()
    players = ['MyNewBot', 'MyNewBotImproved']
    window = PlanetWarsWindow(gamestate=gamestate, players=players, max_game_length=1000)
    app.run()
